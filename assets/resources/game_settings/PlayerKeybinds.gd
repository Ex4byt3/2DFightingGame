...
export(InputEventKey) var default_light_attack_key = InputEventKey.new()
export(InputEventKey) var default_medium_attack_key = InputEventKey.new()
export(InputEventKey) var default_heavy_attack_key = InputEventKey.new()
export(InputEventKey) var default_impact_key = InputEventKey.new()
export(InputEventKey) var default_dash_key = InputEventKey.new()
export(InputEventKey) var default_block_key = InputEventKey.new()
export(InputEventKey) var default_shield_key = InputEventKey.new()
...
export(InputEventKey) var default_light_attack_key_p2 = InputEventKey.new()
export(InputEventKey) var default_medium_attack_key_p2 = InputEventKey.new()
export(InputEventKey) var default_heavy_attack_key_p2 = InputEventKey.new()
export(InputEventKey) var default_impact_key_p2 = InputEventKey.new()
export(InputEventKey) var default_dash_key_p2 = InputEventKey.new()
export(InputEventKey) var default_block_key_p2 = InputEventKey.new()
export(InputEventKey) var default_shield_key_p2 = InputEventKey.new()
